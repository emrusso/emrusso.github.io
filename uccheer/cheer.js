    ...
    .controller('CheerController', function($http) {
        ...
        for (var i in this.roster) {
            ...
            if (cheerleader.hasRosterPicture == "yes") {
                cheerleader.photo = "Media/roster_photos/Roster" + cheerleader.first + ".jpg";
                cheerleader.class = "roster-info";
            } else {
                cheerleader.photo = "";
                cheerleader.class = "roster-info-nm"
            }
            cheerleader.name = cheerleader.first + " " + cheerleader.last;
        }
...
var RosterEntry = function(first, last, year, major, position, hometown, hs, old) {
    this.first = first;
    this.last = last;
    this.year = year;
    this.major = major;
